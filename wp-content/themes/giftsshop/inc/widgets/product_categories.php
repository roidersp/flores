...
if(!class_exists('Ftc_Product_Categories_Widget')){
	class Ftc_Product_Categories_Widget extends WP_Widget {
		...
		function __construct() {
			$widgetOps = array('classname' => 'widget-product-categories', 'description' => esc_html__('Display Your Product Categories', 'giftsshop'));
			parent::__construct('ftc_product_categories', esc_html__('FTC - Product Categories', 'giftsshop'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
			...
			<div class="ftc-product-categories-wrp widget-product-categories">
				<?php 
					$args = array(
		...
		function form( $instance ) { 
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_post_count'); ?>"><?php esc_html_e('Show post count', 'giftsshop'); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_sub_cat'); ?>"><?php esc_html_e('Show sub categories', 'giftsshop'); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('hide_empty'); ?>"><?php esc_html_e('Hide empty categories', 'giftsshop'); ?></label>
			</p>
			<p>
				...
				<span class="description"><?php esc_html_e("Don't select to show all", "giftsshop"); ?></span>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id('orderby'); ?>"><?php esc_html_e('Order by', 'giftsshop'); ?></label>
				<select class="widefat" id="<?php echo $this->get_field_id('orderby'); ?>" name="<?php echo $this->get_field_name('orderby'); ?>" >
					<option value="name" <?php selected($instance['orderby'], 'name'); ?> ><?php esc_html_e('Name', 'giftsshop'); ?></option>
					<option value="slug" <?php selected($instance['orderby'], 'slug'); ?> ><?php esc_html_e('Slug', 'giftsshop'); ?></option>
					<option value="count" <?php selected($instance['orderby'], 'count'); ?> ><?php esc_html_e('Number product', 'giftsshop'); ?></option>
					<option value="rand" <?php selected($instance['orderby'], 'rand'); ?> ><?php esc_html_e('Random', 'giftsshop'); ?></option>
					<option value="none" <?php selected($instance['orderby'], 'none'); ?> ><?php esc_html_e('None', 'giftsshop'); ?></option>
				</select>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id('order'); ?>"><?php esc_html_e('Order', 'giftsshop'); ?></label>
				<select class="widefat" id="<?php echo $this->get_field_id('order'); ?>" name="<?php echo $this->get_field_name('order'); ?>" >
					<option value="asc" <?php selected($instance['order'], 'asc'); ?> ><?php esc_html_e('Ascending', 'giftsshop'); ?></option>
					<option value="desc" <?php selected($instance['order'], 'desc'); ?> ><?php esc_html_e('Descending', 'giftsshop'); ?></option>
				</select>
			</p>
