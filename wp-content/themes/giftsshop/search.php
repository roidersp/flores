...
<div class="container">
	...
	<header class="page-header">
		<?php if ( have_posts() ) : ?>
			<h1 class="page-title"><?php printf( __( 'Search Results for: %s', 'giftsshop' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
		<?php else : ?>
			<h1 class="page-title"><?php _e( 'Nothing Found', 'giftsshop' ); ?></h1>
		<?php endif; ?>
	</header><!-- .page-header -->
	...
	<div id="primary" class="content-area">
		...
		if ( have_posts() ) :
			...
			<p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'giftsshop' ); ?></p>
			<?php
				get_search_form();
