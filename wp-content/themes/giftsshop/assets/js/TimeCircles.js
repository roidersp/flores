 ...
 **/
 (function($) {
    ...
    var color1= $('#mega_main_menu.primary > .menu_holder > .menu_inner > ul > li.current-menu-item > .item_link').css("background-color");
    // alert(color1);
    if(!color1){
      var  color1= $('#mega_main_menu.primary > .menu_holder > .menu_inner > ul > li.current-menu-ancestor > .item_link').css("color");
      if(!color1){
        var color1="#e74c3c";
      }
    }
