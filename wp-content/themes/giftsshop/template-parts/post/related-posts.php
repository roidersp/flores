...
?>
	<div class="related-posts related <?php echo ($is_slider)?'loading':'' ?>">
		<header class="theme-title">
                    <h3 class="title_sub"><span class="bg-heading"><span><?php esc_html_e('Related Posts', 'giftsshop'); ?></span></span></h3>
		</header>
				...
				<article>
					...
					<div class="post-info">
						...
						<?php endif; ?>
                            ...
                            <span class="vcard author"><?php esc_html_e('Posted by: ', 'giftsshop'); ?><?php the_author_posts_link(); ?></span>
                            <?php endif; ?>	
                            <?php endif; ?>
						</header>	
						
						<!-- Blog Excerpt -->
						<p class="excerpt"><?php ftc_the_excerpt_max_words(18, '', true, '', true); ?></p>
						
						<!-- Blog Read More -->
						<a href="<?php the_permalink(); ?>" class="button-readmore"><?php esc_html_e('Read More','giftsshop') ?></a>
					</div>
				</article>
				<?php endwhile; ?>
			</div>
